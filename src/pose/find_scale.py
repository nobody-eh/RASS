...
class Generate_Real_Scale():
    def __init__(self, system_param):
        ...
        scale = 0.15
        offset = 0.5
        scaling_factor = (ave_radio * (scale + offset)) + ave_radio
    ...
    def chessboard_detection(self, chessboard_pth, name_list, chess_T):
        ...
        for pth, name in zip(chessboard_pth, name_list):
            ...
            largest_two_labels = [sorted_components[0][0], sorted_components[1][0], sorted_components[2][0], sorted_components[3][0]]
            ...
            if ret:
                ...
                for corner in corners:
                    cv2.circle(cur_img, (int(corner[0][0]), int(corner[0][1])), radius=5, color=(255, 0, 0), thickness=10)

                # # Display the image
                # cv2.imshow('Chessboard Corners', cur_img)
                # cv2.waitKey(0)
                # cv2.destroyAllWindows()
        ...
        if len(useful_path) < 10:
            print("The number of chessboards that can be detected is less than 15! Please readjust the threshold chess_T !")
    ...
    def generate_scale_info(self, near_pts_3d, std_dist):
        ...
        max_radio = std_dist / min(mid_dist)
...
if __name__ == "__main__":
    ...
    system_param = {"data_root":"/home/amughrabi/projects/datasets/cvpr-metafood-3d-food-reconstruction-challenge/MTF_Challenge/MTF_Challenge/",
                    "save_root":"/home/amughrabi/projects/datasets/cvpr-metafood-3d-food-reconstruction-challenge/MTF_Challenge/MTF_Challenge/",
                    "data_name": "14",
                    "colmap_pth": "sparse",
                    "ply_name": "fused.ply",
                    "chess_h": 3,
