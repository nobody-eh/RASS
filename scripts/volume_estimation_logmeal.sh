...
# find "$DATASET_PATH" -mindepth 1 -maxdepth 1 -type d | parallel -I? --max-args 1 --jobs 8 --linebuffer python src/ARCORE_TO_NERF_LOGMEAL.py --dataset_path ?
...
find "$DATASET_PATH" -mindepth 1 -maxdepth 1 -type d | parallel -I? --max-args 1 --jobs 7 --linebuffer python src/measurements.py --dataset_path "?"
